...
class CasadiOptimizer(Optimizer):
    ...
    def equal_constraints(self, states, ref_states, controls, f):
        ...
        for i in range(self.predict_horizon+1):
            ...
            g.append(ca.sqrt((ego_circles_centers_tuple[0][0] - self.obstacle_circles_centers_tuple[1][0]) ** 2 + (ego_circles_centers_tuple[0][1] - self.obstacle_circles_centers_tuple[1][1]) ** 2))
            g.append(ca.sqrt((ego_circles_centers_tuple[0][0] - self.obstacle_circles_centers_tuple[2][0]) ** 2 + (ego_circles_centers_tuple[0][1] - self.obstacle_circles_centers_tuple[2][1]) ** 2))
            g.append(ca.sqrt((ego_circles_centers_tuple[1][0] - self.obstacle_circles_centers_tuple[0][0]) ** 2 + (ego_circles_centers_tuple[1][1] - self.obstacle_circles_centers_tuple[0][1]) ** 2))
            ...
            g.append(ca.sqrt((ego_circles_centers_tuple[1][0] - self.obstacle_circles_centers_tuple[2][0]) ** 2 + (ego_circles_centers_tuple[1][1] - self.obstacle_circles_centers_tuple[2][1]) ** 2))
            g.append(ca.sqrt((ego_circles_centers_tuple[2][0] - self.obstacle_circles_centers_tuple[0][0]) ** 2 + (ego_circles_centers_tuple[2][1] - self.obstacle_circles_centers_tuple[0][1]) ** 2))
            g.append(ca.sqrt((ego_circles_centers_tuple[2][0] - self.obstacle_circles_centers_tuple[1][0]) ** 2 + (ego_circles_centers_tuple[2][1] - self.obstacle_circles_centers_tuple[1][1]) ** 2))
